...
// ResJSON 响应JSON数据
func ResJSON(c *gin.Context, statusCode int, message string, v interface{}) {
	...
	c.Data(statusCode, "application/json; charset=utf-8", buf)
	c.Abort()
}
...
func ResError(c *gin.Context, err error, status ...int) {
	...
	//	Message: res.Message,
	//}
	ResJSON(c, res.StatusCode, res.Message, "")
}
